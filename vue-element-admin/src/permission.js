        ...
        try {
          ...
          menuData.data.filter(m => m.parnetId == emptyGuid).forEach(root => {
            let currNode = {
              ...
              alwaysShow: root.isShow, // will always show the root menu
            ...
            menuData.data.filter(m => m.parnetId == root.parnetId).forEach(temp => {
              menuData.data.filter(m => m.parnetId == temp.parnetId).forEach(submenu => {
